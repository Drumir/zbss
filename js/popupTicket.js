  ...
  if (typeof(response.result) === 'object') {
    ...
    if(i != response.result.length){  // Если строка с пингом найдена
      ...
      if(response.result[i].lastvalue == 1){
        ...
        document.getElementById('ptZping').title = "Узел доступен";
        ...
        if(delay > 60){                                                  // пинг подзалежался
          ...
          document.getElementById('ptZping').title = "Последнее обновление было больше минуты назад";
        }
        if(delay > 300){                                                 // пинг протух
          document.getElementById('ptZping').style.color = "#605600";
          document.getElementById('ptZping').title = "Последнее обновление было больше 5 минут назад";
        }
        if(delay > 3600){                                                 // пинг протух
          document.getElementById('ptZping').style.color = "#C0AA00";
          document.getElementById('ptZping').title = "Последнее обновление было больше часа назад";
        }
        if(delay > 3600*24){                                                 // пинг протух
          document.getElementById('ptZping').style.color = "#FFA000";
          document.getElementById('ptZping').title = "Последнее обновление было больше суток назад";
        }
      }
      else{
        document.getElementById('ptZping').style.color = "#FF2222";     // пинг кончился
        document.getElementById('ptZping').title = "Узел недоступен";
